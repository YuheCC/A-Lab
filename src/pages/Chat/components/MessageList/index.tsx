...
interface MessageListProps {
  ...
  onRegenerateMessage?: (messageId: string, mode?: 'regular' | 'deep-space' | 'clarify' | 'lightning' | 'ask' | 'fast-deep-space') => void;
  onMoleculeClick?: (moleculeName: string) => void;
  onEditMessage?: (messageId: string, newText: string) => void;
  onMessageUpdate?: (messageId: string, newText: string, mode?: 'regular' | 'deep-space' | 'clarify' | 'lightning' | 'ask' | 'fast-deep-space') => Promise<void>;
  className?: string;
}
