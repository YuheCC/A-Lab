...
interface MessageListProps {
  ...
  onRegenerateMessage?: (messageId: string, mode?: 'regular' | 'deep-space' | 'clarify' | 'lightning' | 'fast' | 'ask') => void;
  onMoleculeClick?: (moleculeName: string) => void;
  onEditMessage?: (messageId: string, newText: string) => void;
  onMessageUpdate?: (messageId: string, newText: string, mode?: 'regular' | 'deep-space' | 'clarify' | 'lightning' | 'fast' | 'ask') => Promise<void>;
  className?: string;
}
