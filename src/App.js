  ...
  return (
    <div className="terms-container" style={{ display: 'flex', width: '93%', paddingLeft: '0' }}>
      ...
      <div className="terms-content" style={{
        ...
        <h1 style={{ fontSize: '28px', marginBottom: '20px', textAlign: 'center', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>Terms of Use</h1>
        <p style={{ fontSize: '16px', marginBottom: '30px', textAlign: 'center', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>Last Modified: {currentDate}</p>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>1. Definitions.</h2>
        ...
        <p style={{ marginBottom: '10px' }}><span style={{ fontWeight: 'bold' }}>"Fees"</span> means the fees described in an Order or the payment page of <a href="https://molecular-universe.ses.ai/pricing">https://molecular-universe.ses.ai</a> that are required to be paid by the Customer for the Services.</p>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>2. Access and Use.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>7. Privacy Policy.</h2>
        <p style={{ marginBottom: '15px' }}>Provider complies with its <span style={{ fontWeight: 'bold' }}>Privacy Policy</span>, available at <a href="https://www.ses.ai/privacy" target="_blank" rel="noopener noreferrer">https://www.ses.ai/privacy</a> ("Privacy Policy"), in providing the Services. The Privacy Policy is subject to change as described therein. By accessing, using, and providing information to or through the Services, you acknowledge that you have reviewed and accepted our Privacy Policy, and you consent to all actions taken by us with respect to your information in compliance with the then-current version of our Privacy Policy.</p>

        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>8. Intellectual Property Ownership; Feedback.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>9. Limited Warranty and Warranty Disclaimer.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>10. Indemnification.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>11. Limitations of Liability.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>12. Term and Termination.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>13. Modifications.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>14. Export Regulation.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>15. Compliance.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>16. Governing Law and Jurisdiction.</h2>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '30px', marginBottom: '15px', lineHeight: '1.6', fontFamily: 'Arial, sans-serif' }}>17. Miscellaneous.</h2>
        <p style={{ marginBottom: '15px' }}>This Agreement, including the Order and all documents referenced herein, constitutes the entire agreement and understanding between the parties hereto with respect to the subject matter hereof and supersedes all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, with respect to such subject matter. In the event of any inconsistency between the body of this Agreement and the Order, the body of this Agreement controls unless the parties expressly indicate in the Order an intent to deviate from the terms of this Agreement. Any notices to us must be sent to legaldept@ses.ai or our US corporate headquarters address available at <a href="https://www.ses.ai/contact-us" target="_blank" rel="noopener noreferrer">https://www.ses.ai/contact-us</a> and must be delivered either in person, by email, certified or registered mail, return receipt requested and postage prepaid, or by recognized overnight courier service, and are deemed given upon receipt by us. Notwithstanding the foregoing, you hereby consent to receiving electronic communications from us. These electronic communications may include notices about applicable fees and charges, transactional information, and other information concerning or related to the Services. You agree that any notices, agreements, disclosures, or other communications that we send to you electronically will satisfy any legal communication requirements, including that such communications be in writing. The invalidity, illegality, or unenforceability of any provision herein does not affect any other provision herein or the validity, legality, or enforceability of such provision in any other jurisdiction. Any failure to act by us with respect to a breach of this Agreement by you or others does not constitute a waiver and will not limit our rights with respect to such breach or any subsequent breaches. This Agreement is personal to you and may not be assigned or transferred for any reason whatsoever without our prior written consent and any action or conduct in violation of the foregoing will be void and without effect. We expressly reserve the right to assign this Agreement and to delegate any of its obligations hereunder.</p>

        <div style={{ marginTop: '40px', borderTop: '1px solid #ddd', paddingTop: '30px' }}>
          <h1 id='scroll-down-acceptable' style={{ fontSize: '28px', marginBottom: '20px', textAlign: 'center' }}>Acceptable Use Policy</h1>
