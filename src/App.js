...
const Navbar = ({ activePage, isAuthenticated, username, onLogout, onSignIn, onPasswordReset, showPasswordReset }) => {
  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar-links">
        ...
        <a
          href="/"
          className={`navbar-link ${(activePage === 'explorer' || activePage === 'about' || activePage === 'search' || activePage === 'chatbot' || activePage === 'enterprise') && showPasswordReset !== true ? 'active' : ''}`}
        >
          Molecular Universe
        </a>
      </div>
