...
// Component for individual hoverable molecule links
const MoleculeLink = ({ text, data, style }) => {
  ...
  // Transform the inline molecule data to MolCard format
...
export const InlineMoleculeRenderer = ({ content }) => {
