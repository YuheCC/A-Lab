...
const Sidebar = ({ children, style }: { children?: React.ReactNode, style?: React.CSSProperties }) => {
            ...
            <div className="about-text-section left-text" style={{ width: '7%', minWidth: 100, overflowY: 'auto', padding: '20px', backgroundColor: '#f1f1f1', borderRadius: '0 8px 8px 0', marginLeft: '0', marginRight: '20px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '9px' }}>
                    <a
                        ...
                        onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => e.currentTarget.style.fontSize = '12.3px'}
                        onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => e.currentTarget.style.fontSize = '9.5px'}
                        onClick={(e) => {
                            e.preventDefault();
                            navigate('/about');
                            setTimeout(() => {
