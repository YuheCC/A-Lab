export default {
    ...
    electrode: {
        ...
        subtitle: "一个数据驱动的AI模型，旨在预测、分析和优化电极材料对电池性能的影响。该模型支持材料和电池的趋势分析和逆向设计，并可使用客户提供的数据集进行微调，以满足专业电池研发需求。",
        features: {
            resultPrediction: {
                title: "性能预测",
                description: "预测电池性能"
        ...
        introduction: {
            ...
            resultPrediction: {
                title: "1. 性能预测",
                description1: "性能预测基于电极材料选择和配方参数，在给定电池设计下，提供数据驱动的电池级性能预测——包括卷芯厚度、体积能量密度 (Wh/L)、重量比能 (Wh/kg)、倍率性能和循环寿命（未来开发）。",
                description2: "该功能由基于 SES 专有实验数据库训练的 AI 模型提供支持，能够在无需物理原型制作的情况下，快速且可扩展地评估特定设计配置。它允许工程师评估给定电池设计和配方的预期性能结果，支持高效筛选和比较候选设计。",
                exampleTitle: "示例",
                example: "预测给定电池设计结合特定正负极配方的容量、体积能量密度 (Wh/L)、重量比能 (Wh/kg) 和卷芯厚度。",
                image1Caption: "电极设计",
                image2Caption: "性能预测"
            },
            inverseDesign: {
                title: "2. 逆向设计",
                description1: "逆向设计自动生成满足用户定义性能目标的电极材料的潜在配方。该功能无需手动遍历设计空间，而是在现实的物理和制造约束范围内生成以识别有效的设计候选。这种方法通过揭示电池设计与性能之间的权衡来支持多目标决策，同时避免不切实际或不稳定的解决方案。",
                description2: "",
                exampleTitle: "示例",
                example: "设计一种电极配方，使电池容量在 2.6-4.6 Ah 之间，并能达到至少 290 Wh/kg 和 960 Wh/L。",
                image1Caption: "目标设定",
                image2Caption: "设计推荐",
                image3Caption: "设计详情"
            }
        ...
        predict: {
            ...
            designCapacity: "设计容量",
            specificED: "重量能量密度",
            specificEDTooltip: "基于电池总质量计算的能量密度，包括软包材料、电解液和辅助非活性组分。电解液装载量相对于活性区域约有 41% 的过量。",
        ...
        optimize: {
            ...
            jellyRollThickness: "卷绕厚度",
            volumetricEnergyDensity: "体积能量密度",
            calculate: "计算",
            designRecommendations: "设计推荐",
            trendChartTitle: "推荐趋势图",
            xAxisLabel: "X 轴",
            yAxisLabel: "Y 轴",
            yAxisMaxTwo: "Y 轴最多可选择 2 项",
            trendChartEmpty: "暂无可用于趋势图的数据",
            no: "序号",
            actions: "操作",
            details: "详情",
            designDetails: "设计详情",
