export default {
    ...
    electrode: {
        ...
        introduction: {
            ...
            resultPrediction: {
                title: "1. 结果预测",
                description1: "结果预测基于电极材料选择和配方参数，在给定电池设计下，提供数据驱动的电池级性能预测——包括能量密度、倍率性能和循环寿命（未来开发）。",
                description2: "该模块由基于 SES 专有实验数据库训练的 AI 模型提供支持，能够在无需物理原型制作的情况下，快速且可扩展地评估特定设计配置。它允许工程师评估给定电池设计和配方的预期性能结果，支持高效筛选和比较候选设计。",
                exampleTitle: "示例",
                example: "预测给定电池设计结合特定正负极配方的循环寿命和倍率性能。"
            },
            inverseDesign: {
                title: "2. 逆向设计",
                description1: "逆向设计自动生成满足用户定义性能目标的电极材料和配方参数的可行组合。该模块无需手动遍历设计空间，而是在现实的物理和制造约束范围内搜索以识别有效的设计候选。这种方法通过揭示能量密度、倍率性能和寿命之间的权衡来支持多目标决策，同时避免不切实际或不稳定的解决方案。",
                description2: "逆向设计建立在预测和趋势分析的洞察之上，能够实现目标驱动的设计选项探索，这些选项既高性能又可制造。",
                exampleTitle: "示例",
                example: "设计一种电极配方，在保持高倍率性能和目标循环寿命的同时达到 1000Wh/L。"
            }
        },
        predict: {
            title: "性能预测",
