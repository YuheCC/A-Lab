export default {
  ...
  disclaimer: "注意：此功能基于内部电池数据和特定基准电解液（溶剂 EC/EMC/DEC (2:3:2) + 盐 1M LiPF6/LiFSI + 添加剂 VC/FEC），通过比较添加和不添加添加剂的电池性能来预测新添加剂的影响。如果使用不同的电池设计或基准电解液，结果可能会有所不同。未来更新将扩展功能以支持可定制的基准电解液、多添加剂分析和更广泛的设计灵活性。",
