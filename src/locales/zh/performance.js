export default {
  ...
  disclaimer: "注意：此功能通过使用内部测试数据和定义的基准电解液（溶剂：EC/EMC/DEC 比例 2:3:2；盐：1M LiPF6/LiFSI；添加剂：VC/LiDFP），比较添加和不添加添加剂的电池性能来评估新添加剂的影响。应用于不同的电池设计或基准电解液时，结果可能有所不同。未来更新将扩展功能以支持可定制的基准电解液、多添加剂评估和更大的设计灵活性。",
