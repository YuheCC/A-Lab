export default {
    ...
    chat: {
        ...
        modes: {
            ...
            regularDescription: "基础问答模式，适合日常电池相关问题咨询。提供准确、简洁的回答。预计响应时间约 5 分钟。",
            deepSpaceDescription: "由大型语言模型智能体团队分析您的电池问题，搜索文献和我们的分子数据库，然后协作制作研究级答案。预计响应时间约 20 分钟。",
            lightningDescription: "最低算力，极速回复。预计响应时间约 1 分钟。",
            askDescription: "高算力，提供最佳答案。预计响应时间约 5 分钟。",
