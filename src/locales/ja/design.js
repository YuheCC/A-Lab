export default {
    ...
    electrode: {
        ...
        introduction: {
            ...
            resultPrediction: {
                title: "1. 結果予測",
                description1: "結果予測は、定義されたセル設計内で、電極材料の選択と配合パラメータに基づいて、エネルギー密度、レート性能、サイクル寿命（将来開発）を含むセルレベルの性能についてデータ駆動型の予測を提供します。",
                ...
                exampleTitle: "例",
                example: "特定の正極および負極配合と組み合わせた特定のセル設計のサイクル寿命とレート性能を予測します。"
            },
            inverseDesign: {
                title: "2. 逆設計",
                description1: "逆設計は、ユーザー定義の性能目標を満たす電極材料と配合パラメータの実現可能な組み合わせを自動的に生成します。設計空間を手動で反復処理するのではなく、このモジュールは現実的な物理的および製造上の制約内で検索し、有効な設計候補を特定します。このアプローチは、エネルギー密度、レート性能、寿命の間のトレードオフを明らかにすることで、多目的意思決定をサポートし、非実用的または不安定なソリューションを回避します。",
                description2: "逆設計は、予測とトレンド分析からの洞察に基づいて構築され、高性能で製造可能な設計オプションの目標駆動型の探索を可能にします。",
                exampleTitle: "例",
                example: "高レート性能と目標サイクル寿命を維持しながら、1000Wh/Lを達成する電極配合を設計します。"
            }
        },
        predict: {
            title: "性能予測",
