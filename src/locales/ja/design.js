export default {
    ...
    electrode: {
        ...
        subtitle: "電極材料が電池性能に与える影響を予測、分析、最適化するために設計されたデータ駆動型AIモデル。材料と電池の両方のトレンド分析と逆設計をサポートし、専門的な電池研究開発のために顧客提供のデータセットで微調整できます。",
        features: {
            resultPrediction: {
                title: "性能予測",
                description: "電池性能を予測"
        ...
        introduction: {
            ...
            resultPrediction: {
                title: "1. 性能予測",
                description1: "性能予測は、定義されたセル設計内で、電極材料の選択と配合パラメータに基づいて、ジェリーロール厚さ、体積エネルギー密度（Wh/L）、重量比エネルギー（Wh/kg）、レート性能、サイクル寿命（将来開発）を含むセルレベルの性能についてデータ駆動型の予測を提供します。",
                description2: "SES の独自実験データベースで学習された AI モデルを活用し、物理的なプロトタイピングを必要とせずに、特定の設計構成の迅速でスケーラブルな評価を可能にします。これにより、エンジニアは特定のセル設計と配合の予想される性能結果を評価でき、候補設計の効率的なスクリーニングと比較をサポートします。",
                exampleTitle: "例",
                example: "特定の正極および負極配合と組み合わせた特定のセル設計の容量、体積エネルギー密度（Wh/L）、重量比エネルギー（Wh/kg）、ジェリーロール厚さを予測します。",
                image1Caption: "電極設計",
                image2Caption: "性能予測"
            },
            inverseDesign: {
                title: "2. 逆設計",
                description1: "逆設計は、ユーザー定義の性能目標を満たす電極材料の実現可能な配合を自動的に生成します。設計空間を手動で反復処理するのではなく、この機能は現実的な物理的および製造上の制約内で生成し、有効な設計候補を特定します。このアプローチは、セル設計と性能の間のトレードオフを明らかにすることで、多目的意思決定をサポートし、非実用的または不安定なソリューションを回避します。",
                description2: "",
                exampleTitle: "例",
                example: "セル容量が2.6〜4.6 Ahの間にあり、少なくとも290 Wh/kgと960 Wh/Lを達成できる電極配合を設計します。",
                image1Caption: "目標設定",
                image2Caption: "設計推奨",
                image3Caption: "設計詳細"
            }
        ...
        predict: {
            ...
            specificEDTooltip: "パウチ材料、電解液、補助非活性成分を含む電池総質量に基づいて計算されたエネルギー密度。電解液充填量は活性面積に対して約41%過剰です。",
        ...
        optimize: {
            ...
            trendChartTitle: "推奨トレンドチャート",
            xAxisLabel: "X軸",
            yAxisLabel: "Y軸",
            yAxisMaxTwo: "Y軸は最大2項目まで選択できます",
            trendChartEmpty: "トレンドチャートに表示できるデータがありません",
            no: "No.",
            actions: "操作",
            details: "詳細",
            designDetails: "設計詳細",
