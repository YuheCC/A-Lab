export default {
    ...
    chat: {
        ...
        modes: {
            ...
            regularDescription: "基本的なQ&Aモード。日常的なバッテリー関連の質問に適しています。正確で簡潔な回答を提供します。応答時間は約5分です。",
            deepSpaceDescription: "LLMエージェントのチームがあなたのバッテリーに関する質問を分析し、文献と分子データベースを精査し、協力して研究レベルの回答を作成します。応答時間は約20分です。",
            lightningDescription: "最低計算量で素早い回答。応答時間は約1分です。",
            askDescription: "最大計算量で最高品質の回答。応答時間は約5分です。",
