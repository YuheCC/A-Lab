export default {
  ...
  disclaimer: "注意：この機能は、内部セルデータおよび特定のベンチマーク電解液（溶媒 EC/EMC/DEC (2:3:2) + 塩 1M LiPF6/LiFSI + 添加剤 VC/FEC）に基づいて、添加剤ありとなしのセル性能を比較することにより、新しい添加剤の影響を予測します。異なるセル設計またはベンチマーク電解液を使用する場合、結果は異なる可能性があります。今後のアップデートでは、カスタマイズ可能なベンチマーク電解液、複数添加剤分析、およびより広範な設計柔軟性をサポートする機能を拡張する予定です。",
