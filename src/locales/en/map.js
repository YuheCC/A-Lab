export default {
  ...
  anionsClusters: {
    ...
    cluster0: 'condensed fluoro-sulfonamide and sulfonyl groups.',
    cluster1: 'condensed fluoro-sulfonamide and sulfonyl groups attached to heterocyclic aromatic structures.',
    cluster2: 'presence of condensed aromatic (and aliphatic) cyclic structures.',
    cluster3: 'presence of arenes, mostly heterocyclic aromatic C₄H₄N₂ substructures (pyridine, pyrimidine, pyridazine)​.',
    cluster4: 'presence of sulfonyl zwitterions and heterocyclic aromatic 6-member groups.',
    cluster5: 'presence of heterocyclic 5-member rings.',
    cluster6: 'presence of tetra-coordinated B- anions and sulfonyl or fluoro-sulfonyl groups.',
    cluster7: 'presence of trifluoro-methyl or trifluoro-borane groups and phosphoryl-lyke groups.',
    cluster8: 'presence of trifluoro-methyl or trifluoro-borane groups and of heterocyclic aliphatic rings (with B, O, N heteroatoms).',
    cluster9: 'presence of tri-coordinated P.',
    cluster10: 'presence of trifluoromethyl and trifluoroborate groups.',
    cluster11: 'presence of trifluoromethyl and trifluoroborate groups (similar to cluster #10).',
    cluster12: 'presence of trifluoromethyl and trifluoroborate groups (similar to clusters #10 and #11).'
  },
  clusters: {
    clusterName: 'Cluster',
