export default {
    ...
    batteryInfoRecommendation: 'Recommended battery information to help intelligent find friends find the most relevant molecules for you: Cathode, Anode, Salt, Electrolyte formulation, Cell design, Desired performance metric.',
