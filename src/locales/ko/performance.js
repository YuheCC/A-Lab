export default {
  ...
  disclaimer: "이 기능은 특정 벤치마크 전해액 제형 및 내부적으로 생성된 셀 데이터를 기반으로 새로운 첨가제가 셀 성능에 미치는 영향을 예측합니다. 사용자가 다른 셀 설계 또는 벤치마크 전해액을 사용하는 경우 예측 결과가 실제 성능과 다를 수 있습니다. 독립적인 검증을 권장합니다.",
