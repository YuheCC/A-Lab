export default {
    ...
    introduction: {
        ...
        example: {
            title: "예시",
            paragraph1: "한 예에서, 모델 기반 예측은 시간에 따른 SOH 열화 추세를 포착하여 배터리 수명 종료를 약 1308 사이클로 추정했습니다. 일정한 페이드 속도를 가정하는 대신, 예측은 비선형 노화 거동을 투영하여 측정된 SOH 변화와 일치하는 궤적을 생성했습니다. 이 경우, 모델은 수직 빨간 점선으로 표시된 사이클까지의 데이터(약 143 사이클)를 사용하고 비정상 사이클을 제외하여 예측을 위한 안정적인 열화 추세를 확립했습니다. 실제 수명 종료는 1396 사이클(용량 확인 사이클 제외)에서 관찰되었으며, 이는 약 6.3%의 예측 오차에 해당합니다.",
