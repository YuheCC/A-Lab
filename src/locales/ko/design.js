    ...
    train: {
        ...
        instruction: {
            ...
            notes: {
                ...
                p5: {
                    title: "5부: 셀 성능 데이터",
                    item1: "사이클 수명 (25°C): 25°C, 1C-1C 사이클 조건에서 배터리 용량이 80%로 감소할 때까지의 사이클 수.",
                    item2: "평균 쿨롱 효율 (25°C): 25°C, 1C-1C 사이클 조건에서 배터리 용량이 80%로 감소할 때까지 각 사이클 쿨롱 효율의 평균값.",
                    item3: "5C 방전 에너지 유지율 (25°C): 25°C 조건에서 5C 속도로 방전했을 때의 에너지 유지율.",
                    item4: "사이클 수명 (45°C): 45°C, 1C-1C 사이클 조건에서 배터리 용량이 80%로 감소할 때까지의 사이클 수.",
                    item5: "평균 쿨롱 효율 (45°C): 45°C, 1C-1C 사이클 조건에서 배터리 용량이 80%로 감소할 때까지 각 사이클 쿨롱 효율의 평균값.",
