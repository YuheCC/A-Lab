export default {
    ...
    chat: {
        ...
        modes: {
            ...
            regularDescription: "기본 Q&A 모드로, 일상적인 배터리 관련 질문에 적합합니다. 정확하고 간결한 답변을 제공합니다. 응답 시간은 약 5분입니다.",
            deepSpaceDescription: "배터리 질문을 분석하고 문헌과 분자 데이터베이스를 검색한 후 협력하여 연구급 답변을 작성하는 LLM 에이전트 팀입니다. 응답 시간은 약 20분입니다.",
            lightningDescription: "최소 연산으로 빠른 응답. 응답 시간은 약 1분입니다.",
            askDescription: "최대 연산으로 최고의 품질 제공. 응답 시간은 약 5분입니다.",
